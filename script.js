...
const bgMusic = new Audio("young-and-beautiful.mp3");
bgMusic.loop = true;
bgMusic.volume = 0.6; // adjust volume (0 to 1)
...
async function playBackgroundMusic(){
  try{
    ...
    // If blocked, user must tap again
    musicBtn.textContent = "Tap again to play 🎵";
  }
}

// Play when she clicks YES (romantic moment)
yesBtn.addEventListener("click", () => {
  playBackgroundMusic();
});

// Or allow manual play
